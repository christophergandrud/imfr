...
```{r count_invalid_dbs, echo=FALSE, include=FALSE, eval=FALSE}
library(tidyverse)
...
This function returns the IMF's listing of `r nrow(databases)` databases available through the API. (In reality, many of the listed databases are defunct and not actually available.)
