...
Finally, we can feed the modified list object to the `imf_dataset` data function as its `parameters` argument. For illustration purposes, we will only request data for the years from 1995 to 2010.

```{r imf_dataset, include=FALSE}
df <- imf_dataset(database_id = commodity_db$database_id,parameters=params,
